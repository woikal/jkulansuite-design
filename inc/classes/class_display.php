...
#    }
    ...
    function StartTab($name, $icon = '')
    {
        ...
        if ($icon) {
            $name = '<img src="design/images/icon_' . $icon . '.png" height="14" alt="' . $icon . '" /> ' . $name;
        }
        $this->tabNames[] = $name;
...
#		$MainContent .= "    <li class='ui-state-default ui-corner-top".$additional."'><a href='".$link."' title='".$title."'><em>".$content."</em></a></li>\n";
    ...
    */
    ...
    function AddTextAreaMailRow($name,
                                $key,
                                $value,
                                $errortext,
                                $cols = NULL,
    ...
    function AddTextAreaPlusRow($name,
                                $key,
                                $value,
                                $errortext,
                                $cols = NULL,
                            ...
                            $additional = NULL)
    {
        ...
        if ($time > 0) {
            ...
            if ($values['day'] != "" and $values['month'] != "" and $values['year'] != "") {
                $day   = $values['day'];
                $month = $values['month'];
                $year  = $values['year'];
                $hour  = $values['hour'];
    ...
    // TODO: Review!
    function AddPictureSelectRow($key,
                                 $path,
                                 $pics_per_row = NULL,
                                 $max_rows = NULL,
                                 $optional = NULL,
