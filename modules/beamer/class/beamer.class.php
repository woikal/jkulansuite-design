...
class beamer
{
    ...
    function countContent($status = NULL, $beamerid = null)
    ...
    function getCurrentContent($beamerid)
    {
        ...
        switch ($row['contentType']) {
            ...
            case 'wrapper':
                ...
                $iframe = "<iframe class=\"beamerIframe\" src=\"{$arr[0]}\">No iframes supported.</iframe>";
                return $iframe;

                break;

            case 'turnier':
                $t = "<h2>" . $row['caption'] . "</h2><iframe class=\"beamerTournamentTree\" src=\"index.php?mod=tournament2&amp;action=tree_frame&amp;design=base&amp;tournamentid={$row['contentData']}&amp;group=0\" style=\"width: 100%; min-width: 600px;\">No iframes supported.</iframe>";
