...
class beamer_display {
	...
	global $dsp, $lang, $beamermodul, $bcid, $beamerid,$cfg;
	    ...
	    if ( $a1 > 0 ) { $btn1 = $dsp->FetchSpanButton(t('Beamerfenster starten'), "index.php?mod=beamer&action=viewcontent&beamerid=1&design=beamer&sitereload=".$cfg['beamer_duration_default'].'" target="_blank');	}
	    if ( $a2 > 0 ) { $btn2 = $dsp->FetchSpanButton(t('Beamerfenster starten'), "index.php?mod=beamer&action=viewcontent&beamerid=2&design=beamer&sitereload=".$cfg['beamer_duration_default'].'" target="_blank');	}
	    if ( $a3 > 0 ) { $btn3 = $dsp->FetchSpanButton(t('Beamerfenster starten'), "index.php?mod=beamer&action=viewcontent&beamerid=3&design=beamer&sitereload=".$cfg['beamer_duration_default'].'" target="_blank');	}
	    if ( $a4 > 0 ) { $btn4 = $dsp->FetchSpanButton(t('Beamerfenster starten'), "index.php?mod=beamer&action=viewcontent&beamerid=4&design=beamer&sitereload=".$cfg['beamer_duration_default'].'" target="_blank');	}
	    if ( $a5 > 0 ) { $btn5 = $dsp->FetchSpanButton(t('Beamerfenster starten'), "index.php?mod=beamer&action=viewcontent&beamerid=5&design=beamer&sitereload=".$cfg['beamer_duration_default'].'" target="_blank');	}
