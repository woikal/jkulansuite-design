...
class teamspeakDisplayClass {
	...
	function displayTeamspeakEx($settings) {
		...
		if ($serverInfo["queryerror"] != 0) {
			...
			echo("<table><tr><td>");
			echo("<img src=\"ext_inc/teamspeak2/teamspeak_offline.png\" alt=\"\" title=\"" . $popupInfo . "\">");
			...
			echo("	var nickname=window.prompt('".t('Nickname eintragen')."', '');\n");
			...
			echo("<table><tr><td>");
			echo("<img src=\"ext_inc/teamspeak2/teamspeak_online.png\" alt=\"\" title=\"" . $popupInfo . "\">");
			echo("</td><td class=\"teamspeakserver\" title=\"" . $popupInfo . "\">");
